...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow fixed">
    ...
    <ul class="navbar-nav ">
        <li class="nav-item"> <a class="nav-link line-1" href="{{route('project.index')}}" ><i class="fa fa-chevron-left" aria-hidden="true"></i> <span class="mobile-hide">Quay lại</span> </a> </li>
    </ul>
