...
<div class="d-sm-flex align-items-center justify-content-between mb-3 flex">
    ...
    <a class="add-iteam" href="{{route('channel.create')}}"><button class="btn-success form-control" type="button"><i class="fa fa-plus" aria-hidden="true"></i> Thêm mới</button></a>
</div>
                ...
                ?>
                    <tr id="channel">
                        ...
                        <td style="display: flex;">
                            ...
                            <form action="{{route('channel.destroy', [$val->id])}}" method="POST">
                              @method('DELETE')
                              @csrf
